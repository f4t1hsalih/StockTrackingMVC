...
namespace StockTrackingMVC.Models.Entity
{
    public partial class tbl_products
    {
        ...
        [StringLength(50, ErrorMessage = "Marka adý en fazla 50 karakter olabilir.")]
        ...
        [Range(0, double.MaxValue, ErrorMessage = "Alýþ fiyatý negatif olamaz.")]
        public Nullable<decimal> prd_purchasePrice { get; set; }

        [Range(0, double.MaxValue, ErrorMessage = "Satýþ fiyatý negatif olamaz.")]
